...
/* Loads trained model */
async function init() {  
  model = await tf.loadModel('/static/dl/tfjs-models/model/model.json');
}
...
function drawRotated(){
  ...
  function random_digit() {
    ...
    document.getElementById('audio_source').src=`/static/dl/audio/digits/${digit}.mp3`;
